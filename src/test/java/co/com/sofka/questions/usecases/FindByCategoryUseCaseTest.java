...
class FindByCategoryUseCaseTest {
    ...
    public void findByCategoryTest() {
        ...
        Mockito.when(questionRepository.findByCategory(questionDTO.getCategory())).thenReturn(Flux.just(question));

        var resultQuestionDTO = findByCategoryUseCase.apply(questionDTO.getCategory()).collectList().block();
